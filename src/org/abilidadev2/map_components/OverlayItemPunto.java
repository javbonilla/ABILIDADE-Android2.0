...
public class OverlayItemPunto {
	...
	public OverlayItemPunto(String title, String direccion, String descripcion, String imagenPrincipal, String imagenAux1, String imagenAux2, String imagenThumb) {
		this.sTitulo      = title;
